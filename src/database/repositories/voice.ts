...
export class VoiceRepository extends Repository<Voice> {
  ...
  async createVoicePreview(voiceId: string): Promise<Voice> {
    ...
    const ssml = {
      ...
      Japanese: [
        `<speak>
          <p>地球とは、人類など多くの生命体が生存する天体である。太陽系にある惑星の1つ。</p>
          <p>太陽から3番目に近く、表面に水、空気中に酸素を大量に蓄え、多様な生物が生存することを特徴とする惑星である。</p>
          <p>地球とは我々人類が住んでいる天体、つまり我々の足元にある天体のことである。</p>
          <p>「地」という字・概念と「球」という字・概念でそれを表現している。英語 やラテン語 など他の言語でも多くは「大地」を表す語が当てられている。</p>
          <p>単語としての「地球」は中国語由来である。中国語の「地球」は明朝の西学東漸（中国語版）期に初めて見られ、イタリア人宣教師マテオ・リッチ（1552年-1610年）の『坤輿万国全図』がこの単語が使用された最初期の資料である。</p>
        </speak>`,
        `<speak>
          <p>月は、地球の唯一の衛星である。太陽系の衛星中で5番目に大きい。地球から見て太陽に次いで明るい。</p>
          <p>古くは太陽に対して太陰とも、また日輪（ = 太陽）に対して月輪（がちりん）とも言った。</p>
          <p>太陽系の中で地球に最も近い自然の天体であり、人類が到達したことのある唯一の地球外天体でもある（「アポロ計画」を参照）。</p>
          <p>地球から見える天体の中では太陽の次に明るく、白色に光って見えるが、これは自ら発光しているのではなく、太陽光を反射したものである。</p>
        </speak>`,
        `<speak>
          <p>火星は、太陽系の太陽に近い方から4番目の惑星である。地球型惑星に分類され、地球の外側の軌道を公転している。</p>
          <p>英語圏では、その表面の色から、Red Planet（レッド・プラネット、「赤い惑星」の意）という通称がある。</p>
          <p>火星は地球型惑星に分類される、いわゆる硬い岩石の地表を持った惑星である。火星が赤く見えるのは、その表面に地球のような水の海が無く、地表に酸化鉄（赤さび）が大量に含まれているためである。</p>
          <p>直径は地球の半分ほどで、質量は地球の約 10分の1に過ぎないため、火星の地表での重力の強さは地球の40パーセントほどしかない。</p>
        </speak>`
      ],
      Slovak: [
        `<speak>
