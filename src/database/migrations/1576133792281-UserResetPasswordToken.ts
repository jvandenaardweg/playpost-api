...
export class UserResetPasswordToken1576133792281 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`ALTER TABLE "publisher" DROP COLUMN "name"`, undefined);
        await queryRunner.query(`ALTER TABLE "publisher" ADD "name" character varying(50) NOT NULL`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "publisher" DROP COLUMN "name"`, undefined);
        await queryRunner.query(`ALTER TABLE "publisher" ADD "name" character varying NOT NULL`, undefined);
    }
