...
exports.getArticleIdFromUrl = (url) => {
...
exports.getArticle = (url) => {
    ...
    return node_fetch_1.default(`${url}?format=json`)
...
exports.getArticleById = (mediumPostId) => {
    console.log(`Getting Medium Post by ID: ${mediumPostId}...`);
    return exports.getArticle(`https://medium.com/p/${mediumPostId}`);
};
