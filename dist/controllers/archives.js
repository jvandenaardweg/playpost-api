...
exports.getArchives = (req, res) => __awaiter(this, void 0, void 0, function* () {
    // TODO: get auth user id
    return res.json({ message: 'get the archive from user ID: X' });
});
exports.postArchives = (req, res) => __awaiter(this, void 0, void 0, function* () {
    // TODO: get auth user id
    const { id } = req.body;
    return res.json({ message: `add article ${id} to archive for user ID: X` });
});
exports.deleteArchives = (req, res) => __awaiter(this, void 0, void 0, function* () {
    // TODO: get auth user id
